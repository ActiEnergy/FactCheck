...
FactCheck 是一个基于 Claude Code 的 AI 调研工具，通过 Skill 协调 Collector、PosEvaluator、NegEvaluator、Judge、Report Agent 五个 Agent 协作，自动生成带可信度标注的调研报告。
...
基于 Claude Code Skill 框架，构建了 5 个协作 Agent：
